...
class SolidityContract(EVMContract):
    ...
    def _is_autogenerated_code(self, length: int, file_index: int) -> bool:
        """
        ...
        if length == len(self.solidity_files[file_index].data.lstrip().rstrip()):
            return True
    ...
    def _get_solc_mappings(self, srcmap, constructor=False):
        ...
        for item in srcmap:
            ...
            if self._is_autogenerated_code(length, idx):
                lineno = None
            else:
                lineno = (
